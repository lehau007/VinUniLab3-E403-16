...
class LocalProvider(LLMProvider):
    ...
    def generate(self, prompt: str, system_prompt: Optional[str] = None) -> Dict[str, Any]:
        ...
        response = self.llm(full_prompt, max_tokens=1024, stop=["<|end|>", "Observation:"], echo=False)
        ...
        return {"content": content, "usage": usage, "latency_ms": latency_ms, "provider": "local"}
    ...
    def stream(self, prompt: str, system_prompt: Optional[str] = None) -> Generator[str, None, None]:
        ...
        stream = self.llm(full_prompt, max_tokens=1024, stop=["<|end|>", "Observation:"], stream=True)
